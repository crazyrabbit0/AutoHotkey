...
scLV := scGui.Add('ListView', "w600 h400 -ReadOnly"
    , ["Device", "#", "Component", "Volume", "Mute"])
...
loop
{
    ...
    loop
    {
        ...
        scLV.Add("", devName, dev, Qualify(cmpName, cmpMap, A_Index), vol, mute)
    }
}
